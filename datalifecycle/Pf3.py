...
#Read consolidated facilities dataset
...
#sectors_metadata.loc[:"industrialsectorname"] = ""
...
for index, row in sectors_list.iterrows():
    ...
    #filtered_data = facilities_data[facilities_data["sector"] == row["dataset_industrialsectorname"], "management"] =
    ...
    #facilities_data.loc[facilities_data[facilities_data["sector"]] == row["industrialsectorname"] ,"industrialsectorname"] = current_name
